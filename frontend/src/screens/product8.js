...
<div>
    <div className = "header">
      ...
      <div className="home">
        ...
        <div className = "logo" ><img src = {logos} width = "125px" alt="label 73"></img>
      ...
      <div className ="content clearfix">
                <div className = " main-content">
                    <div className="Post">
                        <img src= {Flabel11} className ="post-image" alt="label 74"></img>
                        <div className="post-preview">
                            <h1 className ="color-blog">PSR Frame Sliders No Cut for FZ6R 09-17 </h1>
                            <br></br>
                            <p className= "preview-text">his purchase is for a set of frame sliders for the above bike model. The sliders feature a new design of a complete solid puck without a hollowed-out center. This increases the strength and contact surface to about 30%. The bracket is bolted to the engine mount and the slider puck is bolted onto it.</p>
                        </div>
                </div>  
        </div> 
    ...
    <div className="small-container">
        <div class="row">
            <div class="col-4">
                <img src={Flabel1} alt="label 75"></img>
            ...
            <div class="col-4">
                <img src={Flabel2} alt="label 76"></img>
            ...
            <div class="col-4">
                <img src={Flabel3} alt="label 77"></img>
                <h4>SEAT CONCEPTS COMPLETE SEAT (LOW) FOR DR-Z400SM 00-19
</h4>
                <div class="rating">
                    <i class="fa fa-star" ></i>
            ...
            <div class="col-4">
                <img src={Flabel4} alt="label 78"></img>
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="footer-col-2">
                   <img src={logos} alt="footer13"></img>
