...
<div>
    <div className = "header">
      ...
      <div className="home">
        ...
        <div className = "logo" ><img src = {logos} width = "125px" alt="label 57"></img>
      ...
      <div className ="content clearfix">
                <div className = " main-content">
                    <div className="Post">
                        <img src= {Flabel8} className ="post-image" alt="label 58"></img>
                        <div className="post-preview">
                            <h1 className ="color-blog">LSL Crash Pads (Pair) Red</h1>
                            <br></br>
                            <p className= "preview-text">Crash pads for mounting kits. Must order appropriate mounting kit to make complete kit. Sold as a pair</p>
                        </div>
                </div>  
        </div> 
    ...
    <div className="small-container">
        <div class="row">
            <div class="col-4">
                <img src={Flabel1} alt="label 59"></img>
            ...
            <div class="col-4">
                <img src={Flabel2} alt="label 60"></img>
            ...
            <div class="col-4">
                <img src={Flabel3} alt="label 61"></img>
                <h4>SEAT CONCEPTS COMPLETE SEAT (LOW) FOR DR-Z400SM 00-19
</h4>
                <div class="rating">
                    <i class="fa fa-star" ></i>
            ...
            <div class="col-4">
                <img src={Flabel4} alt="label 62"></img>
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="footer-col-2">
                   <img src={logos} alt="footer10"></img>
