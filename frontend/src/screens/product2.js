...
<div>
    <div className = "header">
      ...
      <div className="home">
        ...
        <div className = "logo" ><img src = {logos} width = "125px" alt="label 41"></img>
      ...
      <div className ="content clearfix">
                <div className = " main-content">
                    <div className="Post">
                        <img src= {Flabel5} className ="post-image" alt="label 42"></img>
                        <div className="post-preview">
                            <h1 className ="color-blog">CRG 3 Inch Colored Hindsight Mirror</h1>
                            <br></br>
                            <p className= "preview-text">CRG Hindsight LS Mirror. The Hindsight LS (Lane Splitter) Bar End Mirror was created by adding the folding / retractable feature to the original Hindsight</p>
                        </div>
                </div>  
        </div> 
    ...
    <div className="small-container">
        <div class="row">
            <div class="col-4">
                <img src={Flabel1} alt="label 43"></img>
            ...
            <div class="col-4">
                <img src={Flabel2} alt="label 44"></img>
            ...
            <div class="col-4">
                <img src={Flabel3} alt="label 45"></img>
                <h4>SEAT CONCEPTS COMPLETE SEAT (LOW) FOR DR-Z400SM 00-19
</h4>
                <div class="rating">
                    <i class="fa fa-star" ></i>
            ...
            <div class="col-4">
                <img src={Flabel4} alt="label 46"></img>
